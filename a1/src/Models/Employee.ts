...
export class Employee {
    ...
    constructor(id: number, firstName: string, lastName: string, email: string, position: string, status: string, staff_id: number, staff_fname: string, staff_lname: string, reporting_manager: number) {
      this.id = id;
